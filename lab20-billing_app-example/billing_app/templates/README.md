...
3. Go to `<minikube service rest-app url>/swagger-ui/index.html`. This is the REST applications's Swagger endpoint. You can use this to experiment with the REST commands.
