...
import com.gs.noncolocated.Department;
...
public class NonColocatedDataGen {
    final static int N_STUDENTS=100;
    final static int N_COURSES = 100000;
    final static int N_COURSE_PER_STUDENT = 50;
    final static int BATCH_SIZE = 5000;

    public static void main(String[] args) throws SQLException {
        GigaSpace gs = new GigaSpaceConfigurer(new SpaceProxyConfigurer("demo")).gigaSpace();
        NonColocatedDataGen dataGenerator = new NonColocatedDataGen();
    ...
    public void writeData(GigaSpace gs){
        ...
        ArrayList<StudentCourses> studentCourses = new ArrayList<>(N_STUDENTS* N_COURSE_PER_STUDENT);
        for (int k=1; k<= N_STUDENTS; k++){
